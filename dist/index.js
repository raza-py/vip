...
var SQLiteDialect = class {
  ...
  buildUpdateQuery({ table, set, where, returning, withList }) {
    ...
    const returningSql = returning ? sql2` returning ${this.buildSelection(returning, { isSingleTable: true })}` : void 0;
    const whereSql = where ? sql2` where ${where}` : void 0;
    return sql2`${withSql}update ${table} set ${setSql}${whereSql}${returningSql}`;
  }
  /**
    ...
    if (joins) {
      for (const [index, joinMeta] of joins.entries()) {
        ...
        if (is(table2, SQLiteTable)) {
          ...
          joinsArray.push(
            sql2`${sql2.raw(joinMeta.joinType)} join ${tableSchema ? sql2`${sql2.identifier(tableSchema)}.` : void 0}${sql2.identifier(origTableName)}${alias && sql2` ${sql2.identifier(alias)}`} on ${joinMeta.on}`
          );
        } else {
          joinsArray.push(
            sql2`${sql2.raw(joinMeta.joinType)} join ${table2} on ${joinMeta.on}`
          );
        }
  ...
  buildInsertQuery({ table, values, onConflict, returning, withList }) {
    ...
    return sql2`${withSql}insert into ${table} ${insertOrder} values ${valuesSql}${onConflictSql}${returningSql}`;
  }
  sqlToQuery(sql22) {
  ...
  buildRelationalQuery({
    ...
    if (nestedQueryRelation) {
      let field = sql2`json_array(${sql2.join(
        selection.map(
          ({ field: field2 }) => is(field2, SQLiteColumn) ? sql2.identifier(field2.name) : is(field2, SQL.Aliased) ? field2.sql : field2
        ),
        sql2`, `
      )})`;
...
var SQLiteD1Session = class extends SQLiteSession {
  ...
  async transaction(transaction, config) {
    ...
    await this.run(sql2.raw(`begin${config?.behavior ? " " + config.behavior : ""}`));
    try {
...
var UserPanel = /* @__PURE__ */ __name(({ user }) => {
  const expiryISO = (/* @__PURE__ */ new Date(`${user.expirationDate}T${user.expirationTime}Z`)).toISOString();
  return /* @__PURE__ */ React.createElement("html", null, /* @__PURE__ */ React.createElement("head", null, /* @__PURE__ */ React.createElement("title", null, "User Panel"), /* @__PURE__ */ React.createElement("script", { src: "https://unpkg.com/htmx.org@1.9.12" }), /* @__PURE__ */ React.createElement("script", { src: "https://unpkg.com/alpinejs@3.14.0", defer: true }), /* @__PURE__ */ React.createElement("link", { href: "https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css", rel: "stylesheet" })), /* @__PURE__ */ React.createElement("body", { class: "bg-gray-900 text-white p-8" }, /* @__PURE__ */ React.createElement("div", { class: "max-w-4xl mx-auto" }, /* @__PURE__ */ React.createElement("h1", { class: "text-3xl font-bold mb-4" }, "VLESS User Panel"), /* @__PURE__ */ React.createElement("div", { class: "bg-gray-800 p-6 rounded-lg shadow-lg" }, /* @__PURE__ */ React.createElement("h2", { class: "text-xl font-semibold mb-4" }, "Welcome, ", user.uuid), /* @__PURE__ */ React.createElement("div", { "hx-get": `/api/user/${user.uuid}/stats`, "hx-trigger": "every 5s" }), /* @__PURE__ */ React.createElement("div", { "x-data": "{ qrCodeUrl: '' }" }, /* @__PURE__ */ React.createElement("button", { ...{ "@click": "qrCodeUrl = `/api/qr?data=...`" }, class: "bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" }, "Show QR Code"), /* @__PURE__ */ React.createElement("template", { "x-if": "qrCodeUrl" }, /* @__PURE__ */ React.createElement("img", { ...{ ":src": "qrCodeUrl" } }))), /* @__PURE__ */ React.createElement("div", { "x-data": "{ timeLeft: '' }", "x-init": "\n                            const expiry = new Date('{expiryISO}');\n                            setInterval(() => {\n                                const now = new Date();\n                                const diff = expiry.getTime() - now.getTime();\n                                if (diff < 0) {\n                                    timeLeft = 'Expired';\n                                } else {\n                                    const days = Math.floor(diff / (1000 * 60 * 60 * 24));\n                                    const hours = Math.floor((diff % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));\n                                    const minutes = Math.floor((diff % (1000 * 60 * 60)) / (1000 * 60));\n                                    const seconds = Math.floor((diff % (1000 * 60)) / 1000);\n                                    timeLeft = `${days}d ${hours}h ${minutes}m ${seconds}s`;\n                                }\n                            }, 1000);\n                        " }, /* @__PURE__ */ React.createElement("p", null, "Time Remaining: ", /* @__PURE__ */ React.createElement("span", { "x-text": "timeLeft" })))))));
}, "UserPanel");
...
var users = sqliteTable("users", {
  ...
  createdAt: text("created_at").default(sql2`(strftime('%Y-%m-%d %H:%M:%S', 'now'))`).notNull(),
...
var adminSessions = sqliteTable("admin_sessions", {
  tokenHash: text("token_hash").primaryKey(),
  expiresAt: integer("expires_at", { mode: "timestamp" }).notNull()
});
var connectionEvents = sqliteTable("connection_events", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  timestamp: integer("timestamp", { mode: "timestamp" }).default(sql2`(strftime('%Y-%m-%d %H:%M:%S', 'now'))`).notNull(),
  uuid: text("uuid"),
  ip: text("ip"),
...
var getUserByUuid = /* @__PURE__ */ __name(async (db, uuid) => {
  return await db.select().from(users).where(eq2(users.uuid, uuid)).get();
}, "getUserByUuid");
var createUser = /* @__PURE__ */ __name(async (db, user) => {
  await db.insert(users).values(user).run();
}, "createUser");
var updateUser = /* @__PURE__ */ __name(async (db, uuid, user) => {
  await db.update(users).set(user).where(eq2(users.uuid, uuid)).run();
}, "updateUser");
var deleteUser = /* @__PURE__ */ __name(async (db, uuid) => {
  await db.delete(users).where(eq2(users.uuid, uuid)).run();
}, "deleteUser");

// src/vless/utils.ts
import vlessParserWasm from "./9632166e44829263e1df10f8ff148aab81fbca69-vless_parser_bg.wasm";

// src/rust/pkg/vless_parser.js
var wasm;
...
function parse_vless_header(buffer) {
  const ptr0 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
  const len0 = WASM_VECTOR_LEN;
  const ret = wasm.parse_vless_header(ptr0, len0);
  if (ret[2]) {
    throw takeFromExternrefTable0(ret[1]);
  }
  return takeFromExternrefTable0(ret[0]);
}
__name(parse_vless_header, "parse_vless_header");
...
var VlessHeader = class {
  __destroy_into_raw() {
    ...
    this.__wbg_ptr = 0;
    VlessHeaderFinalization.unregister(this);
    return ptr;
  }
  free() {
    const ptr = this.__destroy_into_raw();
    wasm.__wbg_vlessheader_free(ptr, 0);
  }
  /**
   * @returns {number}
   */
  get version() {
    const ret = wasm.__wbg_get_vlessheader_version(this.__wbg_ptr);
    return ret;
  }
  /**
   * @param {number} arg0
   */
  set version(arg0) {
    wasm.__wbg_set_vlessheader_version(this.__wbg_ptr, arg0);
  }
  /**
   * @returns {string}
   */
  get uuid() {
    ...
    let deferred1_1;
    try {
      const ret = wasm.__wbg_get_vlessheader_uuid(this.__wbg_ptr);
      deferred1_0 = ret[0];
      deferred1_1 = ret[1];
  ...
  set uuid(arg0) {
    ...
    const len0 = WASM_VECTOR_LEN;
    wasm.__wbg_set_vlessheader_uuid(this.__wbg_ptr, ptr0, len0);
  }
  /**
   * @returns {number}
   */
  get command() {
    const ret = wasm.__wbg_get_vlessheader_command(this.__wbg_ptr);
    return ret;
  }
  /**
   * @param {number} arg0
   */
  set command(arg0) {
    wasm.__wbg_set_vlessheader_command(this.__wbg_ptr, arg0);
  }
  /**
   * @returns {number}
   */
  get port() {
    const ret = wasm.__wbg_get_vlessheader_port(this.__wbg_ptr);
    return ret;
  }
  /**
   * @param {number} arg0
   */
  set port(arg0) {
    wasm.__wbg_set_vlessheader_port(this.__wbg_ptr, arg0);
  }
  /**
   * @returns {AddressType}
   */
  get address_type() {
    const ret = wasm.__wbg_get_vlessheader_address_type(this.__wbg_ptr);
    return ret;
  }
  /**
   * @param {AddressType} arg0
   */
  set address_type(arg0) {
    wasm.__wbg_set_vlessheader_address_type(this.__wbg_ptr, arg0);
  }
  /**
   * @returns {string}
   */
  get address() {
    ...
    let deferred1_1;
    try {
      const ret = wasm.__wbg_get_vlessheader_address(this.__wbg_ptr);
      deferred1_0 = ret[0];
      deferred1_1 = ret[1];
      return getStringFromWasm0(ret[0], ret[1]);
    } finally {
  ...
  set address(arg0) {
    const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.__wbg_set_vlessheader_address(this.__wbg_ptr, ptr0, len0);
  }
  /**
   * @returns {number}
   */
  get raw_data_index() {
    const ret = wasm.__wbg_get_vlessheader_raw_data_index(this.__wbg_ptr);
    return ret >>> 0;
  }
  /**
   * @param {number} arg0
   */
  set raw_data_index(arg0) {
...
__name(initializeWasm, "initializeWasm");
async function parseVlessHeaderWithWasm(buffer) {
...
// src/routes/vless.tsx
import { connect } from "cloudflare:sockets";
var vlessRouter = new Hono2();
vlessRouter.get("/:uuid", async (c) => {
  ...
  try {
    ...
    return c.html(/* @__PURE__ */ React.createElement(UserPanel, { user }));
  } catch (e) {
...
vlessRouter.get("/", async (c) => {
  if (c.req.headers.get("Upgrade")?.toLowerCase() === "websocket") {
    ...
    const updateUsage = /* @__PURE__ */ __name(async (uuid) => {
      if (sessionUsage > 0) {
        try {
          await db.update(schema.users).set({ trafficUsed: sql`${schema.users.trafficUsed} + ${sessionUsage}` }).where(eq(schema.users.uuid, uuid));
          sessionUsage = 0;
        } catch (dbError) {
...
var AdminDashboard = /* @__PURE__ */ __name(({ users: users2 }) => {
  return /* @__PURE__ */ React.createElement("html", null, /* @__PURE__ */ React.createElement("head", null, /* @__PURE__ */ React.createElement("title", null, "Admin Dashboard"), /* @__PURE__ */ React.createElement("script", { src: "https://unpkg.com/htmx.org@1.9.12" }), /* @__PURE__ */ React.createElement("script", { src: "https://unpkg.com/alpinejs@3.14.0", defer: true }), /* @__PURE__ */ React.createElement("link", { href: "https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css", rel: "stylesheet" })), /* @__PURE__ */ React.createElement("body", { class: "bg-gray-900 text-white p-8" }, /* @__PURE__ */ React.createElement("div", { class: "max-w-6xl mx-auto" }, /* @__PURE__ */ React.createElement("h1", { class: "text-3xl font-bold mb-4" }, "Admin Dashboard"), /* @__PURE__ */ React.createElement("div", { class: "bg-gray-800 p-6 rounded-lg shadow-lg" }, /* @__PURE__ */ React.createElement("h2", { class: "text-xl font-semibold mb-4" }, "Users"), /* @__PURE__ */ React.createElement("div", { "hx-get": "/admin/users", "hx-trigger": "every 60s", "hx-swap": "outerHTML" }, /* @__PURE__ */ React.createElement("table", { class: "min-w-full divide-y divide-gray-700" }, /* @__PURE__ */ React.createElement("thead", { class: "bg-gray-700" }, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { class: "px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider" }, "UUID"), /* @__PURE__ */ React.createElement("th", { class: "px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider" }, "Notes"), /* @__PURE__ */ React.createElement("th", { class: "px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider" }, "Actions"))), /* @__PURE__ */ React.createElement("tbody", { class: "bg-gray-800 divide-y divide-gray-700" }, users2.map((user) => /* @__PURE__ */ React.createElement("tr", { key: user.uuid }, /* @__PURE__ */ React.createElement("td", { class: "px-6 py-4 whitespace-nowrap" }, user.uuid), /* @__PURE__ */ React.createElement("td", { class: "px-6 py-4 whitespace-nowrap" }, user.notes), /* @__PURE__ */ React.createElement("td", { class: "px-6 py-4 whitespace-nowrap" }, /* @__PURE__ */ React.createElement("button", { class: "text-blue-400 hover:text-blue-600" }, "Edit"), /* @__PURE__ */ React.createElement("button", { "hx-delete": `/admin/users/${user.uuid}`, "hx-confirm": "Are you sure?", class: "text-red-400 hover:text-red-600 ml-4" }, "Delete")))))))))));
}, "AdminDashboard");
...
adminRouter.get("/", async (c) => {
  ...
  return c.html(/* @__PURE__ */ React.createElement(AdminDashboard, { users: users2 }));
});
